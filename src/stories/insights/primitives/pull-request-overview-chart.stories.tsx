...
import PullRequestOverviewChart from "../../../insights/components/primitives/PullRequestOverviewChart/pull-request-overview-chart";

const storyConfig = {
  title: "Design System/Insights/Primitives/Pull Request Overview Chart",
