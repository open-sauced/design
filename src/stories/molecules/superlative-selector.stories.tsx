...
import SuperativeSelector from 'src/components/molecules/SuperlativeSelector/superlative-selector';
...
const SuperlativeSelectorTemplate: ComponentStory<typeof SuperativeSelector> = (
  args
